...
public class ItemLister : MonoBehaviour
{
    ...
    private Dictionary<String, Dictionary<String, double>> distanceHeuristics = new Dictionary<String, Dictionary<String, double>>();
    void Start()
    {
    ...
    private void CalculateHeuristics()
    {
        foreach(GameObject box1 in boxes)
        {
            ...
            double launchpad_distance = getEuclideanDistance(box1.transform.position, this.launchpad.transform.position);
